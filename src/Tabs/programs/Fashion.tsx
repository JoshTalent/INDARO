...
// Fashion Program data - Following Tigers data structure
const fashionProgram = {
  id: "fashion",
  ...
  logo: "https://images.unsplash.com/photo-1485230895905-ec40ba36b9bc?w=400&auto=format&fit=crop",
  motto: "Design Your Future",
  gallery: [
    "https://images.unsplash.com/photo-1485230895905-ec40ba36b9bc?w=800&auto=format&fit=crop",
    ...
    "https://images.unsplash.com/photo-1558769132-94e1c98347c3?w=800&auto=format&fit=crop", // Added
    "https://images.unsplash.com/photo-1557772612-1a6b6d2d7b1e?w=800&auto=format&fit=crop", // Added
    "https://images.unsplash.com/photo-1557772612-1a6b6d2d7b1f?w=800&auto=format&fit=crop", // Added
  ],
  description:
    "Where young designers learn to create, innovate, and launch their fashion careers.",
  longDescription:
    "The Fashion & Creative Design Program, under the Indaro Foundation, provides comprehensive fashion education combining technical sewing skills, design principles, and entrepreneurial training to empower youth through creative expression.",

  leader: {
    name: "Uwase Nadine",
    title: "Head Fashion Designer & Instructor",
    image:
      "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=400&auto=format&fit=crop",
    experience: "8+ years",
    catchphrase:
      "Every stitch tells a story, every design is a dream made real.",
  },
  ...
  schedule: [
    {
      ...
      class: "Fashion Design Basics",
    },
    {
      day: "Tuesday",
      time: "9:00 AM - 12:00 PM",
      class: "Sewing & Tailoring",
    },
    {
      day: "Wednesday",
      time: "9:00 AM - 12:00 PM",
  ...
  classLevels: [
    {
      ...
      age: "Ages 15+",
      description: "Learn sketching, pattern making, and design principles",
    },
    {
      name: "Sewing & Tailoring",
      age: "Ages 16+",
      description: "Master machine sewing and garment construction",
    },
    {
      name: "Creative Design",
      age: "Ages 17+",
      description: "Develop collections and concept portfolios",
    },
    {
      name: "Fashion Business",
      age: "Ages 18+",
      description: "Marketing, pricing, and launching a fashion brand",
    },
  ],
  ...
  achievements: [
    {
      year: "2024",
      items: [
        "👗 Featured at Kigali Fashion Week 2024",
        "🎓 15 graduates launched their own businesses",
        "🏆 Best Youth Fashion Program 2024",
      ],
    },
    {
      year: "2023",
      items: [
        "🌟 8 students showcased at East Africa Fashion Festival",
        "📦 Produced 200+ garments for local community",
      ],
    },
  ],
  ...
  testimonials: [
    {
      ...
      age: "19",
      quote:
        "This program taught me how to turn my sketches into real clothes. Now I have my own small business!",
      achievement: "Launched her brand in 2024",
    },
    {
      name: "Ishimwe Eric",
      age: "22",
      quote:
        "From knowing nothing about sewing to designing my own collection. Forever grateful.",
      achievement: "Showcased at Kigali Fashion Week",
    },
  ],

  equipment: [
    "Notebook and sketching pencils",
    "Basic sewing kit (provided for beginners)",
  ...
  faqs: [
    {
      ...
      a: "No, we welcome complete beginners! We'll teach you everything from threading a needle to operating machines.",
    },
    {
      q: "What materials are provided?",
      a: "Basic sewing kits and practice fabrics are provided. Advanced students may need to purchase their own materials for projects.",
    },
    {
      q: "Can I start my own business after?",
      a: "Yes! Our Fashion Business course teaches you exactly how to launch and market your brand.",
    },
  ],
};

// Fixed Support CTA Component - Following Tigers pattern exactly
const FixedSupportCTA = ({ program }: { program: typeof fashionProgram }) => {
            ...
            <div className="p-6 text-white">
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold">Support Fashion Design</h3>
                </div>
                <button
              ...
              <p className="text-sm text-blue-100 mb-4">
                Help provide sewing machines, materials, and training for
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold">
                    {program.stats.collectionsCreated}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span>Graduate businesses:</span>
...
// Main Fashion Program Page Component - Following Tigers design exactly
const FashionProgram = () => {
  const program = fashionProgram;
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-xl px-4 py-2 border border-blue-400/30">
                  ...
                  <div className="text-blue-300 text-xs">Collections</div>
                </div>
                <div className="bg-white/10 backdrop-blur-md rounded-xl px-4 py-2 border border-blue-400/30">
                  <div className="text-2xl font-bold text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-blue-200">Female Designers</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold">
                {program.stats.collectionsCreated}
              </div>
              <div className="text-xs text-blue-200">Collections</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold">
                {program.stats.yearsRunning}
        ...
        <section className="text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-xl mx-auto">
            Learn to create, innovate, and launch your fashion career today.
          </p>
